...
class Gateway {
	 ...
	 */
	static public $hostedUrl = 'https://gateway.paytriot.co.uk/hosted/';

	/**
	 * @var string	Gateway Direct API Endpoint
	 */
	static public $directUrl = 'https://gateway.paytriot.co.uk/direct/';

	/**
	 * @var string	Merchant Account Id or Alias
	 */
	static public $merchantID = '105631';
	 ...
	 */
	static public $merchantSecret = 'Media49Stone36Carrot';
